...
#### 🔴 Высокий приоритет
- [x] **Milestone при первом прохождении волны** — при первом прохождении волны кратной 10 (10, 20, 30...): флэш-уведомление + маленький бонус золотом. Хранить `state.maxWaveReached`. Простая реализация, высокий эффект на ощущение прогресса.
