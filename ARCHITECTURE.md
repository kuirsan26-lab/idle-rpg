...
> Последнее обновление: 2026-04-21 (v1.3.0: баланс мобов, флаги/элиты в бэклоге)
...
| DODGE | 0% | **75%** | — | только класс (rogue-ветка); из апгрейдов и предметов убран |
| LIFESTEAL | 0% | — | — | только класс (bloodthirst-ветка); из апгрейдов и предметов убран |
| THORNS | 0% | — | — | только класс (paladin-ветка); из апгрейдов и предметов убран |
| MAGICSHIELD | 0% | **75%** | — | только класс (mage-ветка: Маг→Друид→Архидруид/Шаман, Алхимик→Зельевар/Бомбардир; до 22%) |
