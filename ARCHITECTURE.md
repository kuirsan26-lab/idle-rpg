...
> Последнее обновление: 2026-05-10 (v1.11.0: открытие классов +1 ПО + радиальный граф)
...
- [~] **Достижения** — базовая механика реализована (v1.11.0): открытие класса впервые = +1 ПО. Расширение: 10–15 milestone-целей ("Первый босс", "Волна 50", "10K убийств" и т.д.) — в бэклоге
...
- [x] **Ручные классы depth 5** — 68 именных классов Мастерства (v1.10.0); depth 6–10 генерируются от них как сидов
