...
> Последнее обновление: 2026-04-21 (dodge/lifesteal/thorns реализованы)
...
| DODGE | 0% | **75%** | — | класс (rogue-ветка), апгрейды (+2%/ур.), аксессуары |
| LIFESTEAL | 0% | — | — | класс (bloodthirst-ветка), апгрейды (+3%/ур.), оружие |
| THORNS | 0% | — | — | класс (warrior/paladin-ветка), апгрейды (+3%/ур.), броня |
...
- [x] **Уворот (dodge)** — реализован: `getStats()`, `Combat.js`, апгрейды, классы rogue-ветки, аксессуары; cap 75%
- [x] **Вампиризм (lifesteal)** — реализован: heal после каждой атаки, cap maxHp; классы bloodthirst-ветки, оружие
- [x] **Шипы (thorns)** — реализованы: отражение после `takeDamage()`, убийство моба шипами корректно обработано; классы paladin-ветки, броня
